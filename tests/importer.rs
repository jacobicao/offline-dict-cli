use offline_dict_cli::importer::{
    build_persisted_dictionary, load_source_documents_from_directory, SourceDictionaryEntry,
    SourceDocument, SourcePhrase, SourceTranslation,
};
...
#[test]
fn importer_merges_duplicate_headwords_and_builds_phrase_entries() {
    ...
    assert_eq!(
        ...
        PersistedDictionary {
            entries: vec![
                ...
                DictionaryEntry {
                    headword: "abandon ship".to_string(),
                    definitions: vec!["弃船".to_string()],
                    tags: vec![],
                }
            ]
        }
